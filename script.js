...
function openCompletedJournal(record=getCompletedJournal()){
  ...
  openModal(`<div class="journal-v4 journal-v4-readonly">
    ...
    <div class="journal-complete-layout">
      <div class="journal-complete-left">
        ...
        <article class="journal-readonly-item journal-readonly-focus">
          <small>最觸動的一句</small>
          <strong>${escapeHTML(record.focus||"未選擇")}</strong>
        </article>
      </div>

      <div class="journal-complete-right">
        ...
        <article class="journal-readonly-item journal-readonly-mood">
          <small>今天的心情</small>
